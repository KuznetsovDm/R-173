...
namespace R_173.Handlers
{
    public class KeyboardHandler
    {
        ...
        public KeyboardHandler(MainWindow _mainWindow)
        {
            ...
            {
                { Key.Space, () => _currentRadioModel.Sending.Value = SwitcherState.Enabled },
            ...
            {
                { Key.Space, () => _currentRadioModel.Sending.Value = SwitcherState.Disabled },
            };
        ...
        private void OnPreviewKeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (_currentRadioModel == null || !_onKeyUpActions.TryGetValue(e.Key, out var action))
                return;
