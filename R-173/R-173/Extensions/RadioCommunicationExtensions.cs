    ...
    public static class RadioCommunicationExtensions
    {
        public static IUnityContainer AddCommunicationServices(this IUnityContainer services)
        {
            services.RegisterInstance<IDataReceiver>(
                ...
                MulticastConnectionOptions.Create(ipAddress: "231.0.0.0", exclusiveAddressUse: false, multicastLoopback: false, useBind: true)));
            ...
            MulticastConnectionOptions.Create(ipAddress: "231.0.0.0", exclusiveAddressUse: false, useBind: false)));
            return services;
        }
