    ...
    public static class RadioCommunicationExtensions
    {
        public static IUnityContainer AddCommunicationServices(this IUnityContainer services)
        {
            services.RegisterInstance<IDataReceiver>(
                ...
                MulticastConnectionOptions.Create(ipAddress: "239.0.0.0", exclusiveAddressUse: false, multicastLoopback: true, useBind: true)));
            ...
            MulticastConnectionOptions.Create(ipAddress: "239.0.0.0", exclusiveAddressUse: false, useBind: false)));
            return services;
        }
